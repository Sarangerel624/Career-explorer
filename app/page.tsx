...
const Page = () => {
  ...
  text-glow-dark-blue font-extrabold text-blue-200 transition-all duration-300"
        ...
        <div className="font-bold text-[25px] leading-tight break-normal md:break-all mt-5 text-white">
      ...
      <section className="py-40 bg-center">
        ...
        <div className="text-[25px] text-white text-center -mt-10 mb-10 ">
      ...
      <section className="w-full bg-cover bg-top py-30 text-white">
        ...
        <div className="relative max-w-6xl mx-auto mt-24">
          ...
          <div className="mt-10">
            <div className="text-[40px] font-bold text-left mt-10 bit-white-glow">
              Бидний зорилго
            </div>
      ...
      <section className="w-full bg-cover bg-top pt-20">
          ...
          <div className="mt-15">
            <Carousel className="w-full px-4">
              <div className="relative">
                <CarouselContent className="-ml-1 mb-10">
                  {userComments?.map((item, index) => {
                    ...
                    return (
                      ...
                      >
                        <div className="p-2">
                          <div
                            className="relative border border-gray-200 rounded-xl items-center gap-2 px-7 py-3 font-semibold text-white h-[300px] w-[450px]
              ...
              hover:brightness-110 hover:-translate-y-[2px] mt-5"
                          >
                            ...
                            <p className="mt-4 text-white text-[17px] leading-relaxed">
                              {item.text}
                            </p>
        ...
        <div className="flex gap-30 pt-14 justify-center -mb-40">
          <div className="pl-8">
            <div className="flex gap-2.5 -mt-3">
              <div className="h-10 w-10 bg-gradient-to-br from-blue-500 to-indigo-600 shadow-[0_0_12px_rgba(59,130,246,0.8)] rounded-2xl text-white text-center pt-1 font-bold text-[20px] mt-3.5">
                CN
              </div>
              <div className="text-[35px] mt-1.5 font-bold text-white">
                Ирээдүйн хөтөч
              </div>
            </div>

            <div className="text-white text-[20px]">
              Карьерын зөв сонголт хийхэд туслах <br /> платформ
            </div>
          </div>
          <div className="flex gap-30  justify-center text-[20px]">
            <div>
              <div className="font-bold text-white">Холбоосууд</div>
              <div className="text-white">Эхлэл</div>
              <div className="text-white">Онцлог</div>
              <div className="text-white">Хэрхэн ажилладаг</div>
            </div>
            <div>
              <div className="font-bold text-white">Мэдээлэл</div>
              <div className="text-white">Бидний тухай</div>
              <div className="text-white">Холбоо барих</div>
            </div>
            <div>
              <div className="font-bold text-white">Нийгмийн сүлжээ</div>
